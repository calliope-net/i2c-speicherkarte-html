...
input.onButtonEvent(Button.A, input.buttonEventClick(), function () {
    ...
    table(bit.hex8(bit.eHEX8bit.x20))
    table(bit.hex8(bit.eHEX8bit.x30))
    table(bit.hex8(bit.eHEX8bit.x40))
    table(bit.hex8(bit.eHEX8bit.x50))
    table(bit.hex8(bit.eHEX8bit.x60))
    table(bit.hex8(bit.eHEX8bit.x70))
